...
-- If yanking without specifying a register, then use the system clipboard register by default.
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Setting up LSPs (without using mason-lspconfig or mason-tool-installer)
