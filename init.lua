...
vim.keymap.set('n', '<leader>rc', ':vsplit $MYVIMRC<CR>', { desc = 'Open Neovim config' })
...
require('lazy').setup({
  ...
  require 'kickstart.plugins.tiny-code-action', -- adds code action for fixing diagnostics
